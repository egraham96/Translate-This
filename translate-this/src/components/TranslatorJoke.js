...
//This component allows users to translate the joke generated by the JokeBox component into a language of their choice
function TranslatorJoke(props) {
  ...
  //Gets user's saved joke (if previously generated) from localStorage
  useEffect(() => {
  ...
  //If user has chosen a language and has a saved joke input, this function submits a post request to the LibreTransate api and generates a translation from English into language of user's choice
